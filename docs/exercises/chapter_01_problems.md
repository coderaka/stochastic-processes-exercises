...
### Problem：双选之力 (Power of Two Choices)
=== "中文"
...
### Problem：乐观的馈赠 (Gift of Optimism)
=== "中文"
...
### Problem：纯粹的探索 (Pure Exploration)
=== "中文"
...
### Problem：区分的代价 (Cost of Distinguishing)
=== "中文"
在公平硬币检验中，我们知道用
$$
...
### Problem：必输之战 (An Unavoidable Loss)
=== "中文"
...
### Problem：均匀性测试 (Uniformity Testing)
=== "中文"
...
### Problem：学习离散分布 (Learning a Discrete Distribution)
=== "中文"
