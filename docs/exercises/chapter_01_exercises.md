...
### Exercise：再探奖券收集问题 (Coupon Collector Revisited)
=== "中文"
...
### Exercise：最大负载期望上界 (Upper Bound on Expected Maximum Load)
=== "中文"
...
### Exercise：精确的代价 (Cost of Exactness)
=== "中文"
...
### Exercise：多数人的智慧 (Wisdom of the Majority)
=== "中文"
...
### Exercise：高斯分布的集中性 (Concentration of Gaussian Distribution)
=== "中文"
...
### Exercise：纠缠的极值 (Entangled Extremes)
=== "中文"
...
### Exercise：次高斯分布初探 (Introduction to Sub-Gaussian Distributions)
=== "中文"
...
### Exercise：次指数分布初探 (Introduction to Sub-Exponential Distributions)
=== "中文"
...
### Exercise：退而求其次 (A Weaker Concentration Alternative)
=== "中文"
...
### Exercise：咫尺天涯 (So Close, Yet So Far)
=== "中文"
